...
const serverHost = process.env.SERVER_HOST || 'qkkv.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '60552', 10);
const botUsername = process.env.BOT_USERNAME || '247_qkkv';
